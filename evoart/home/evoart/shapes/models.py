...
class FacebookSession(models.Model):
    access_toke00, unique=True)
    expires = models.Inn = models.CharField(max_length=2tegerField(null=True)
...
class Collection_Individual(models.Model):
    ...
    added_from = models.ForeignKey(Collection, null=True, related_name='added_from')
